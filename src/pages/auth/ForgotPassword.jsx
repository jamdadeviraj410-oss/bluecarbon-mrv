      ...
      <main className="w-full max-w-[440px] bg-surface-container-lowest p-xl rounded-xl shadow-[0_4px_24px_rgba(0,51,102,0.06)] border border-outline-variant/30 relative overflow-hidden group hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <form className="w-full flex flex-col gap-6 relative z-20" onSubmit={handleSubmit}>
            ...
            <button 
              className={`w-full text-on-primary font-title-md text-title-md py-3 px-6 rounded-xl shadow-md transition-all active:scale-[0.98] flex items-center justify-center gap-2 overflow-hidden relative group/btn ${
                status === 'success' ? 'bg-secondary text-on-secondary hover:shadow-md' : 'bg-primary hover:shadow-lg hover:bg-primary/90'
