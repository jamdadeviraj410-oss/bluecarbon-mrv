...
export default function Login() {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-screen bg-background">
      ...
      <div className="flex flex-col justify-center w-full lg:w-1/2 p-8 sm:p-12 lg:p-24 bg-surface relative">
        ...
        <div className="w-full max-w-[440px] mx-auto relative z-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button 
              className="w-full py-3.5 px-4 bg-primary-container hover:bg-primary text-on-primary rounded-lg font-title-md transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 mt-8 disabled:opacity-80 disabled:cursor-not-allowed" 
              type="submit"
              disabled={isLoading}
            >
              {isLoading ? (
