        ...
        <div className="flex flex-col gap-1.5 relative z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full bg-secondary-container/40 text-on-secondary-container font-mono-data text-xs border border-secondary">
              {stats.activeNetworksCount > 0 ? 'Polygon Amoy (Chain 80002)' : 'Polygon Amoy (Chain 80002)'}
            </span>
          </div>
          <p className="font-body-md text-on-surface-variant max-w-2xl">
            Immutable provenance and tamper-evident audit trail of verified blue carbon MRV records on Polygon Amoy testnet.
          </p>
