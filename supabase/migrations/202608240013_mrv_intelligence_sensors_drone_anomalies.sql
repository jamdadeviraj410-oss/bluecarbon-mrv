-- Migration 13: MRV Intelligence, IoT Sensors, Drone Surveys, OCR Results, and Anomaly Detection Engine
-- Safe, non-destructive migration created by Member 2 (MRV Intelligence Lead)
